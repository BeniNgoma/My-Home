...
import type { Client } from '@caretrack/shared'
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl p-8 w-full max-w-md max-h-screen overflow-y-auto">
            ...
            <form onSubmit={handleEdit} className="space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                <button type="button" className="btn-secondary flex-1" onClick={() => setEditing(null)}>Annuler</button>
                ...
                <tr key={client.id} className="hover:bg-gray-50">
                  ...
                  <td className="table-cell">
                    <button
                      ...
                      title={client.is_active ? 'Cliquer pour désactiver' : 'Cliquer pour réactiver'}
                    >
                  ...
                  <td className="table-cell">
                    <div className="flex items-center gap-3">
                      ...
                      <Link href={`/clients/${client.id}`} className="text-blue-600 hover:text-blue-800 text-sm font-medium">Voir →</Link>
                    </div>
                  </td>
                </tr>
              ))}
